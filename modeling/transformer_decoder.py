...
class VqaTransformerDecoder(nn.Module):
    def __init__(self, clip_model_name, text_model_path=None, num_labels=2, num_heads=4,
        ...
        decoder_layer = TransformerDecoderLayer(input_dim=projection_dim, num_heads=num_heads)
    ...
    def forward(self, 
        ...
        transformer_output = self.transformer(text_features, image_features, None) # shape: (N, T, W)
